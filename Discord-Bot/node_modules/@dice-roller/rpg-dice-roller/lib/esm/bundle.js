...
function peg$parse(input, options) {
  ...
  var peg$f26 = function(text) { return new Description(text.flat().join(''), Description.types.MULTILINE) };
  var peg$f27 = function(text) { return new Description(text.flat().join(''), Description.types.MULTILINE) };
  var peg$f28 = function(text) { return new Description(text.flat().join(''), Description.types.INLINE) };
  var peg$currPos = 0;
  var peg$savedPos = 0;
